...
i=`cat progs | head -n $((configId + 1)) | tail -n1`
  ...
  time ../CSPLlift/lift.sh /scratch/janker/Masterarbeit/TypeChef-mbedtlsAnalysis/$i $flags 2>&1 |  gzip > /scratch/janker/Masterarbeit/TypeChef-mbedtlsAnalysis/$i.single.out.gz
