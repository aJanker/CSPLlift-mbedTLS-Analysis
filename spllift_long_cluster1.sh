...
echo $i
  time ../CSPLlift/lift.sh /scratch/janker/Masterarbeit/TypeChef-mbedtlsAnalysis/$i $flags > /scratch/janker/Masterarbeit/TypeChef-mbedtlsAnalysis/$i.out1.dbg 2>&1
