...
echo $i
  time ../CSPLlift/lift.sh /scratch/janker/Masterarbeit/TypeChef-mbedtlsAnalysis/$i $flags 2>&1 |  tee /scratch/janker/Masterarbeit/TypeChef-mbedtlsAnalysis/$i.out.dbg
