...
#SBATCH --time=6:00:00
#SBATCH --array=0-50
#SBATCH --exclude=chimaira11,chimaira12,chimaira13,chimaira14,chimaira15,chimaira16,chimaira17
...
echo $i
  time ../CSPLlift/lift.sh /scratch/janker/Masterarbeit/TypeChef-mbedtlsAnalysis/$i $flags > /scratch/janker/Masterarbeit/TypeChef-mbedtlsAnalysis/$i.out.dbg 2>&1
